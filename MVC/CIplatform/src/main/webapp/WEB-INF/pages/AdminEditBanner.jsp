		...
		<div class="row flex-nowrap">
			...
			<div class="col-auto col-md-3 col-lg-3 col-xl-2 sidebar">
				<div
					...
					<input type="text" class="bannerId" name="bid" value="${banner.bannerId}" hidden>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
    ...
    let image="";
        ...
        function loadBannerDetail(){
        	$.ajax({
				url : "loadBannerDetail",
				dataType : 'json',
				data :{'bannerId':Number(bannerId)},
				type : "POST",
        ...
        function setBannerDetail(banner){
        	$('.bannerTitle').val(banner.text);
        	let img=`<img src="images/`+banner.image+`" style="height:60px; width:60px;">`;
