...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none;" id="leftMenu">
        <button onclick="closeLeftMenu()" class="w3-bar-item w3-button w3-large "><img src="images/left.png"></button>
        ...
        <div class="dropdown button1">
            ...
            <ul class="dropdown-menu posStatic" aria-labelledby="dropdownMenuButton1">
    ...
    <div class="container-fluid borderH2 d-flex ">
        <div class="container d-flex justify-content-around  ">
            ...
            <div class="col d-flex spacearound">
                <div>
                    <img src="images/logo.png" class="blocking" style="padding-top: 10%;">
                </div>
        ...
        <div class="d-flex justify-content-around">
            ...
            <div class="d-flex">
                <form action="post " class="searchboxh2">
                    ...
                    <input type="text" placeholder=" Search missions..." name="search" class="searchBoxPh">

                </form>
                <button class="w3-button" onclick="openLeftMenu()"><img class="rightbutton"
                        src="images/filter.png"></button>
            </div>

            <div class="dropdown d-flex blocking">

                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" class="vl"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    City <img src="images/drop-down.png">
                </button>
    ...
    <div class="container mb-3 mt-3 d-flex justify-content-end">
        ...
        <a href="http://localhost:8080/CIplatform/homeGrid"><button class="gridimg"><img src="images/grid.png"
                    alt=""></button></a>
        <a href="http://localhost:8080/CIplatform/homeList"><button class="listimg"><img src="images/list.png"
                    alt=""></button></a>
    ...
    <div class="container grid-container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card ">
                    <img class="card-img-top" src="images/Grow-Trees-On-the-path-to-environment-sustainability-3.png">
                    <div class="posAbsolute locationBox d-flex "><i class="bi bi-geo-alt locicon"></i>
                        <p> Toronto</p>
                    </div>
                    <div class="posAbsolute likeBox"><img src="images/heart.png" alt=""></div>
                    <div class="posAbsolute addBox"><i class="bi bi-person-plus"></i></div>
                    <div class="card-body">
                        <div class="category">
                            <p>Environment</p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between" style="margin-bottom: 5%;">
                            ...
                            <div><button class="starbutton"><img src="images/star.png" alt=""></button><button
                                    class="starbutton"><img src="images/star.png" alt=""></button><button
                                    class="starbutton"><img src="images/star.png" alt=""></button><button
                                    class="starbutton"><img src="images/star.png" alt=""></button><button
                                    class="starbutton"><img src="images/star.png" alt=""></button> </div>
                        </div>
                        <hr class="lineintext">
                        ...
                        <div class="d-flex justify-content-center">
                            <button class="d-flex apply ">
                                <div> Apply</div>
                                <div><img src="images/right-arrow.png" alt=""></div>
                            </button>
                        </div>
                    </div>
                </div>
