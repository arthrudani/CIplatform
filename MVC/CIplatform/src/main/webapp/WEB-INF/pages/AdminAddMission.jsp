				...
				<div class="EPbasicInfo addbox">
					...
					<div class="d-flex EPnameSurname justify-content-around mt-1 row">
						<div class="col">
							...
							<div class="col">
								<select name="theme" id="theme" class="theme cmsStatus titlebox ms-3 mt-2 me-3">
						...
						<div class="ms-3 mt-3 titleOfAddbox">Skill</div>
							<div class="col">
								<select name="skill" id="skill" class="skill cmsStatus titlebox ms-3 mt-2 me-3">
					...
					<div class="row">
						<div class="col">
							...
							<input type="file" class=" ms-3 mt-2 me-3 titlebox" id="wizard-picture" multiple>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							<input type="file" class=" ms-3 mt-2 me-3 titlebox" id="wizard-documents" multiple>
						</div>
					</div>
