...
<!-- modal for change password -->
	...
	<input type="text" class="missionid" id="midl" name="mission_id" value="${story.mission.mission_id}" hidden>
        <!-- sidebar starts here -->
        ...
        <div id="midcontainer">
                ...
                <div class="row mx-4 gx-5">
                        ...
                        <div id="wrap">
                            <ul id="slider">
                                <li class="slide-item"><img
                                        ...
                                        alt="画像"></li>
                                <li class="slide-item"><img
                                        src="images/CSR-initiative-stands-for-Coffee--and-Farmer-Equity-4.png" alt="画像">
                                </li>
                                <li class="slide-item"><img
                                        src="images/Education-Supplies-for-Every--Pair-of-Shoes-Sold-2.png" alt="画像">
                                </li>
                                <li class="slide-item"><img src="images/Plantation-and-Afforestation-programme-1.png"
                                        alt="画像"></li>
                                <li class="slide-item"><img src="images/Nourish-the-Children-in--African-country-1.png"
                                        alt="画像"></li>
                            </ul>
                            <ul id="thumbnail_slider">
                                <li class="thumbnail-item"><img
                                        ...
                                        alt="画像"></li>
                                <li class="thumbnail-item"><img
                                        src="images/CSR-initiative-stands-for-Coffee--and-Farmer-Equity-1.png" alt="画像">
                                </li>
                                <li class="thumbnail-item"><img
                                        src="images/Education-Supplies-for-Every--Pair-of-Shoes-Sold-1.png" alt="画像">
                                </li>
                                <li class="thumbnail-item"><img
                                        src="images/Plantation-and-Afforestation-programme-1.png" alt="画像"></li>
                                <li class="thumbnail-item"><img
                                        src="images/Nourish-the-Children-in--African-country-1.png" alt="画像"></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-12 px-6 right-content">
                        ...
                        <div class="SDimg d-flex justify-content-start">
                            <img src="images/<c:out value="${user1.avatar}"></c:out>" class="userimage">
                        </div>
                        <div class="SDunameNviews d-flex justify-content-between">
                            <div class="SDuname">${user1.first_name} ${user1.last_name}</div>
                            <div class="SDviews"><img src="images/eye.png" alt="">12000 Views</div>
                        </div>
                        <div class="SDdetails1">
                            <p style="margin-top: 4%;">Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed
                                doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed do </p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed doLorem ipsum dolor, sit
                                amet consectetur adipisicing elit. sed do </p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed doLorem ipsum dolor, sit
                                amet consectetur adipisicing elit. sed doLorem ipsum dolor, sit amet consectetur
                                adipisicing elit. sed doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed do
                            </p>
                        </div>
                        <div class="d-flex justify-content-around flex-column flex-sm-column  flex-md-row gap-2">
                          
                            <button class="SDRecommend" data-bs-toggle="modal" data-bs-target="#exampleModal1"><i class="bi bi-person-add"></i> 
                            Recommend to a co-worker</button>
                            
                            <form action="openMission" method="GET">
                            <button class="SDOpenMission d-flex align-items-center justify-content-center">
	                            <input type="text" class="userid" id="uidl" name="user_id" value="${story.user.user_id}" hidden>
								<input type="text" class="missionid" id="midl" name="mission_id" value="${story.mission.mission_id}" hidden>
	                            Open mission
            ...
            <div class="related-missions d-flex justify-content-center"
                style="border-top: 1px solid rgba(128, 128, 128, 0.495);">
            </div>

            <div class="container">
                <p style="margin-top: 4%;">Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed doLorem ipsum
                    dolor, sit amet consectetur adipisicing elit. sed do Lorem ipsum dolor, sit amet consectetur
                    adipisicing elit. sed doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed do</p>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed doLorem ipsum dolor, sit amet
                    consectetur adipisicing elit. sed doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed
                    doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed do </p>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. sed doLorem ipsum dolor, sit amet
                    consectetur adipisicing elit. sed doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed
                    doLorem ipsum dolor, sit amet consectetur adipisicing elit. sed do </p>
